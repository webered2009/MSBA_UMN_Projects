...
You can use the `tutorial` package to convert static code chunks into editors where people can experiment with your code. If you specify the `ex` and `type` properties, `tutorial` knows what to do:
...
# Create a variable a, equal to 20
